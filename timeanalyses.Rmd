...
### Shootings Over Time
We wanted to see the longitudinal changes in shootings by borough. This is represented in the stacked bar graph below. There is a decline in shootings from 2005 to 2019, then a sharp increase from 2020 onwards.
...
Murders followed a similar pattern, but the summer of 2020 (and apparently 2010) also had a relatively high rate of murders.
